...
func New() Config {
	return Config{
		...
		UPSImageStreamTag:  getEnv("UPS_IMAGE_STREAM_TAG", "2.4"),
		...
		UPSImageStreamInitialImage:        getEnv("UPS_IMAGE_STREAM_INITIAL_IMAGE", "quay.io/aerogear/unifiedpush-configurable-container:2.4"),
