...
func buildReconcileWithFakeClientWithMocks(objs []runtime.Object, t *testing.T) *ReconcileWebPushVariant {
	s := scheme.Scheme
	...
	s.AddKnownTypes(pushv1alpha1.SchemeGroupVersion, &pushv1alpha1.WebPushVariant{})
	...
	return &ReconcileWebPushVariant{client: cl, scheme: s}
}
