...
func TestReconcileAndroidVariant_Reconcile(t *testing.T) {
	//TODO: Add just as example for we start to cover it with unit tests.
	// objects to track in the fake client
	objs := []runtime.Object{
		&androidVariantInstance,
	}
	...
	req := reconcile.Request{
		NamespacedName: types.NamespacedName{
			Name:      androidVariantInstance.Name,
			Namespace: androidVariantInstance.Namespace,
		},
	}
